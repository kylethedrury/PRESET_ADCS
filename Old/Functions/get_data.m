% THIS IS A FUNCTION FOR GETTING POSITION AND VELOCITY VECTORS OVER AN ORBIT IN ECI, ECEF, and LLA COORDINATES as well as FIELD DATA IN ECI and ECEF

% Import STK orbital trajectory data as tables

function [ECI_position, ECI_velocity, ECEF_position, ECEF_velocity, LLA_position, LLA_velocity, B_ECF, B_ECI] = get_data(LTDN)
